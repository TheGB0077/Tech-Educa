  ...
  <template v-if="prontoOffline || precisoRecarregar">
    <div class="pwa-toast" role="alertdialog" aria-labelledby="pwa-message">
      <div id="pwa-message" class="mb-3">
        {{
          prontoOffline
            ? "O Tech Educa está pronto para uso offline!"
            : "Novo conteúdo disponível, atualize para ver as novidades."
        }}
      </div>
      <button
      ...
      <button type="button" class="pwa-cancel" @click="close">Fechar</button>
    </div>
  </template>
</template>
